################################################################################
##################################            ##################################
######### 09.07) MAP COUNTERFACTUAL TRAVEL-TIME MATRIX SUMMARY BY OD ZONE #######
##################################            ##################################
################################################################################
...
# Retrieving counterfactual long-form travel-time grid (from 09_06; contains
# all 343 x 343 pairs plus the pair-level CSM sample flag)
...
matrix_summary_output <- file.path(output_directory, "counterfactual_matrix_sample_zone_means.parquet")
...
# Reading long-form counterfactual travel-time grid and filtering to the CSM sub-grid
